...
resource "aws_security_group" "alb_sg" {
  name        = "${var.random_id_prefix}-${var.application_name}-api-${terraform.workspace}-alb-sg"
...
resource "aws_security_group" "ecs_sg" {
  name        = "${var.random_id_prefix}-${var.application_name}-api-${terraform.workspace}-ecs-sg"
  vpc_id      = var.vpc_id
