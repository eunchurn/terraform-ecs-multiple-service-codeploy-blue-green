  ...
  [
    {
      ...
      "environment": [
        ...
        },
        {
          ...
          "value": "${module.parameters.APOLLO_GRAPH_REF.value}"
        },
        {
          "name": "S3_ACCESS_KEY_ID",
          "value": "${module.parameters.S3_ACCESS_KEY_ID.value}"
        },
        {
          "name": "IAMPORT_KEY",
          "value": "${module.parameters.IAMPORT_KEY.value}"
        },
        {
          "name": "API_DOMAIN",
